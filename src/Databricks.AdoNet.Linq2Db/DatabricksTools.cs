...
using Databricks.AdoNet.Linq2Db.Internal;

namespace Databricks.AdoNet.Linq2Db;
...
public static class DatabricksTools
{
    ...
    /// <summary>Creates a <see cref="DataConnection"/> from a Databricks.AdoNet connection string.</summary>

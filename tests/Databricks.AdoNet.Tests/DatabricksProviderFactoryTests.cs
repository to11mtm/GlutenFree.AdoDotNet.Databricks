...
public class DatabricksProviderFactoryTests
{
    ...
    {
        DbProviderFactories.RegisterFactory("Databricks.AdoNet.TestReg", DatabricksProviderFactory.Instance);

        var resolved = DbProviderFactories.GetFactory("Databricks.AdoNet.TestReg");

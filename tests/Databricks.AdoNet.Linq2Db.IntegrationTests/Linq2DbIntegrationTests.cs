using Databricks.AdoNet.IntegrationTests;
using Databricks.AdoNet.Linq2Db;
using LinqToDB;
using LinqToDB.Mapping;

namespace Databricks.AdoNet.Linq2Db.IntegrationTests;
...
public sealed class Linq2DbIntegrationTests : IAsyncLifetime
{
    ...
    private readonly string _schema = $"adonet_l2db_{Guid.NewGuid():N}";
